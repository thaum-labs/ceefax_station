...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.1.8--alpha-orange" alt="Version 0.1.8-alpha" />
...
Install the Debian package (tag **v0.1.8** / version 0.1.8-alpha):
...
**Linux (v0.1.8):** [`installers/ceefax-station.deb`](installers/ceefax-station.deb) and [`installers/ceefax-station_0.1.8~alpha-1_all.deb`](installers/ceefax-station_0.1.8~alpha-1_all.deb). Install with `sudo apt install ./installers/ceefax-station.deb`.

**Windows:** [`installers/CeefaxStation-Setup-0.1.8.exe`](installers/CeefaxStation-Setup-0.1.8.exe).
...
installers/       Windows Setup .exe + Linux .deb (last packaged: 0.1.8-alpha / tag v0.1.8)
...
Sample/demo uploads (`source_path` starting with `sample:`) are not emailed.
