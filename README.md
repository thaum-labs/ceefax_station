...
Install the Debian package (tag **v0.1.9** / version 0.1.9-alpha):
...
**Linux (v0.1.9):** [`installers/ceefax-station.deb`](installers/ceefax-station.deb) and [`installers/ceefax-station_0.1.9~alpha-1_all.deb`](installers/ceefax-station_0.1.9~alpha-1_all.deb). Install with `sudo apt install ./installers/ceefax-station.deb`.
